...
<title>GhostProto — ${esc(project.name)}</title>
<style>
  :root {
...
<div class="container">
  ...
  <div class="header">
    <div class="logo"><span>Ghost</span>Proto</div>
  ...
  <div class="card" style="margin-bottom:2rem">
    ...
    <table class="info-table">
      ...
      <tr><td>Analysis</td><td>${report.agentic ? '✦ Agentic (GhostProto + tools)' : report.aiPowered ? '✦ AI-Powered (GhostProto)' : '⚡ Static Only'}</td></tr>
    </table>
  </div>
