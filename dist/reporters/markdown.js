...
function generateMarkdownReport(report, outputPath) {
    ...
    // Header
    lines.push('# 🔍 GhostProto Audit Report');
    lines.push('');
    lines.push(`> Generated by **[ghostproto](https://github.com/AtlasRoX/Ghost-Proto)** · ${new Date(report.timestamp).toLocaleString()}`);
    lines.push('');
    // Project info
    ...
    lines.push(`| **Analysis Type** | ${report.agentic ? '✦ Agentic (GhostProto + tools)' : report.aiPowered ? '✦ AI-Powered (GhostProto)' : '⚡ Static Analysis'} |`);
    ...
    lines.push('---');
    lines.push('');
    lines.push('*Generated by [ghostproto](https://github.com/AtlasRoX/Ghost-Proto) — AI-powered codebase auditor*');
